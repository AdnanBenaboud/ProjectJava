...
(1, 'EL HARRAK', 'AYMANE', 'S22023', 'GI'),
(2, 'BENABOUD', 'ADNAN', 'S22023', 'GI'),
(3, 'DEHDOUH', 'AYOUB', 'S22023', 'GI'),
(21, 'Cristiano', 'Ronaldo', 'S12023', 'GI'),
(22, 'Messi', 'Lionel', 'S12023', 'GI');
...
INSERT INTO `module` (`id_module`, `nom_module`, `description_module`, `id_semestre`) VALUES
('GI11', 'Algorithmique et programmation', 'Algorithmique et programmation en Python\r\n', 'S12023'),
('GI12', 'Analyse numérique', 'Compléments de mathématique et Analyse numérique', 'S12023'),
('GI13', 'Statistique/Analyse des données', 'Statistique/Analyse des donnée', 'S12023'),
('GI14', 'BPT/TS', 'Bases physiques de la télédétection/Traitement du signal', 'S12023'),
('GI15', 'TEC', 'Communication professionnelle', 'S12023'),
('GI16', 'SI et Réseaux', 'Systèmes d’information et réseaux informatique', 'S12023');
...
CREATE TABLE `semestre` (
  ...
  `id_filiere` varchar(20) NOT NULL,
  `annee_semestre` varchar(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
('S12023', 'Semestre 1', 'GI', '2023'),
('S22023', 'Semestre 2', 'GI', '2023'),
('S32023', 'Semestre 3', 'GI', '2023'),
('S42023', 'Semestre 4', 'GI', '2023'),
('S52023', 'Semestre 5', 'GI', '2023'),
('S62023', 'Semestre 6', 'GI', '2023');
...
ALTER TABLE `semestre`
  ADD PRIMARY KEY (`id_semestre`,`id_filiere`),
  ADD KEY `id_filiere` (`id_filiere`);
